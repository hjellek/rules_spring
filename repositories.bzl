...
def rules_spring_example_deps():
    maven_install(
        artifacts = [
            ...
            "org.springframework.boot:spring-boot-configuration-processor:3.2.1",
            "org.springframework.boot:spring-boot-loader:3.2.1",
            "org.springframework.boot:spring-boot-loader-tools:3.2.1",
            "org.springframework.boot:spring-boot-starter:3.2.1",
            "org.springframework.boot:spring-boot-starter-actuator:3.2.1",
            "org.springframework.boot:spring-boot-starter-freemarker:3.2.1",
            "org.springframework.boot:spring-boot-starter-jdbc:3.2.1",
            "org.springframework.boot:spring-boot-starter-jetty:3.2.1",
            ...
            "org.springframework.boot:spring-boot-starter-thymeleaf:3.2.1",
